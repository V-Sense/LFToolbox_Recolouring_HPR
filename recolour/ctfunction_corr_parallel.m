function [param, config] = ctfunction_corr_parallel(paletteFile, targetFolder, newPalette, bitCoding, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(nargin < 4)
    ...
    error('Four input arguements are required: palette image, target folder, first target (used to compute params), target image bit encoding');
elseif(nargin == 4)
    colourSpace = 'RGB';
    numCorr = 5000;
elseif(nargin == 5)
...
outputFileName = 'results/LF/_init_corr.png';
...
%call example : ctfunction_corr_parallel('data/artichoke.jpg', 'data/eucalyptus/', 'data/eucalyptus/in_08_08_3012.329346_1538.333984_.png', 8, 'RGB', 5000)