function [param, config] = ctfunction(paletteFile, targetFile, bitCoding, varargin);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(nargin < 3)
    ...
    error('Three input arguements are required: palette image, target image, target image bit encoding');
elseif(nargin == 3)
...
finalResultT = reshape(fullTransform, [fnrows fncols 3]);
if(bitCoding == 8)
...
%save the result
%disp("Saving the result in results/nocorrresult.png");
imwrite(finalResult, 'results/LF/_recolour.png');


end

%call ex: ctfunction('data/isaac.png', 'data/eucalyptus/out_08_08_3012.329346_1538.333984_.png', 8, 'MVQ', 50, 'RGB');